...
const prompt = "Provide an uplifting affirmation inspired by the vibrant and colorful world of Indian cinema, incorporating emojis that reflect the themes of love, culture, and adventure. Do not include the prompt itself, only return the affirmation";
const conversation = [
  {
    role: "user",
    content: [{ text: prompt }],
...
async function fetchCredentials() {
  ...
  return {
    region: "us-west-2",  // this must match the region you enabled the model on. In my case it's us-west-2. It may not be in your case.
    credentials: {
